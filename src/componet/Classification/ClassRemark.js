...
function ClassRemark() {
    const [istate, updateIstate] = useState(initialState)
    const { projectId, observation, scopeOfImprovement, numOfTries, date, hardwareSetting, loading } = istate;
    ...
    const saveHandler = async () => {
        try {
            ...
            const data = {
                ...
                observation, scopeOfImprovement, numOfTries, date, hardwareSetting
            }
            console.log('payload of remark', data)
            const response = await dispatch(remarkData({data, url}))
