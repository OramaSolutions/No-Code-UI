...
function Augumentation({ initial, setIstate, state, userData, onApply, onChange }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await dispatch(ReturnAgumentation({
    ...
    const saveHandler = async () => {
        ...
        if (!num_of_images_to_be_generated) {
            ...
            try {
                ...
                console.log('augmentationsssss-------', augmentations)
